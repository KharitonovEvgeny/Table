...
public class InsertForm extends javax.swing.JFrame {
    ...
    public InsertForm(Tree tree, HashNote hash, DefaultTableModel model) {
        initComponents();
        t=tree;
        h=hash;
        m=model;     
    ...
    private void initComponents() {
        ...
        jButton1.setForeground(new java.awt.Color(0, 140, 0));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String [] d = {jTextField1.getText(),jTextField2.getText(),jTextField3.getText(),jTextField4.getText()};
        if (d[0].compareTo("")==0||d[1].compareTo("")==0||d[2].compareTo("")==0||d[3].compareTo("")==0)
            new MB("Ошибка! Заполните все поля").setVisible(true);
        else{
            if(h.insert(d[0],d[1],d[2],d[3])==true){
                if (t.insert(d[0],d[1],d[2],d[3])==true){
                    ...
                    h.delete(d[3]);
                    new MB("Такой пасспорт уже существует").setVisible(true);
                }             
            }
            else new MB("Такой номер уже существует").setVisible(true);
            setVisible(false); 
        }
